...
>A detailed explanation of the dataflow programming method, can be found [here](https://proavatar.io/dataflow/).
...
| Sequence      | `[Sample]` | An array of samples, i.e. [(t<sub>0</sub> , f<sub>0</sub>) , ... , (t<sub>N-1</sub> , f<sub>N-1)</sub>]. |
