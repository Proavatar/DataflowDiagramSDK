...
The Dataflow Diagram SDK enables iOS applications to use dataflow diagrams that implement specific algorithms to process for example kinematic values as generated by a motion capture system and calculate specific output values.
