...
The SDK is named “EchtfitDataflowDiagramSDK” and is available as a Swift package via GitHub under the URL:
https://github.com/EchtFit/EchtfitDataflowDiagramSDK.git

To install the “EchtfitDataflowDiagram” Swift package in your project, perform the following steps in Xcode:
...
```swift
import EchtfitDataflowDiagramSDK
```
